/**
 *  @file timer.h
 *  @brief Timer utility classes definition
 *  @author Rodolfo Lima
 *  @author Andre Maximo
 *  @date January, 2011
...
public:
    ...
    /**
     *  @overload void gpu_add(const std::string &label, base_timer *timer)
     *  @brief Add an already instatiated GPU timer to this pool
     *  @param[in] label The label string for this timer
     *  @param[in] timer The GPU timer to be added
     */
    void gpu_add(const std::string &label, base_timer *timer);
