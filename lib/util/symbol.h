/**
 *  @file symbol.h
 *  @brief Device symbol management definition and implementation
 *  @author Rodolfo Lima
 *  @author Andre Maximo
 *  @date February, 2011
...
/**
 *  @ingroup utils
 *  @overload void copy_to_symbol(const T *symbol, const S &symbol_size, const std::vector<T> &items)
 *
...
/**
 *  @ingroup utils
 *  @overload void copy_to_symbol(const T *symbol, IT beg, IT end)
 *
 *  @param[in] symbol Symbols in device (GPU)
...
/**
 *  @ingroup utils
 *  @overload void copy_to_symbol(const T *symbol, const C<T> &items)
 *
 *  @param[in] symbol Symbols in device (GPU)
...
/**
 *  @ingroup utils
 *  @overload void copy_to_symbol(const T *symbol, const C<T,U> &items)
 *
 *  @param[in] symbol Symbols in device (GPU)
 *  @param[in] items Container with symbols items
 *  @tparam C Container class type
...
/**
 *  @ingroup utils
 *  @overload void _copy_to_symbol(const std::string &name, const std::string &size_name, const std::vector<T> &items)
 *
 *  @param[in] name Name of the symbol in device (GPU)
...
/**
 *  @ingroup utils
 *  @overload void _copy_to_symbol(const std::string &name, const std::vector<T> &items)
 *
 *  @param[in] name Name of the symbol in device (GPU)
 *  @param[in] items Host (STL) Vector values
 *  @tparam T Vector values type used in the CPU and the GPU
