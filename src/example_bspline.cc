...
int main(int argc, char *argv[]) {
    ...
    std::cout << "[bspline] Considering mirror as initial condition.\n";

    std::cout << "[bspline] Extending CPU image ... " << std::flush;
...

    {
        ...
        gpufilter::bspline3i_cpu( ext_cpu, ext_h, ext_w, gpufilter::zero, 0 );
