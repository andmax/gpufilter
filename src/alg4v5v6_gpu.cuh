/**
 *  @file alg4v5v6_gpu.cuh
 *  @brief Algorithm 4 or 5 or 6 in the GPU with borders
 *  @author Andre Maximo
 *  @date Nov, 2012
 *  @copyright The MIT License
 */

#ifndef ALG4v5v6_GPU_CUH
#define ALG4v5v6_GPU_CUH
 ...
 *
 *  This function computes the algorithm step 4.2 or 4.4 or 6.2 or 6.4
 *  or 5.4 (corresponding to the steps 4.2 and 4.3 or 4.5 and 4.6 or
 *  5.2 and 5.3 in [NehabEtAl:2011]) following:
 *
...
void alg4v5v6_step2v4( Matrix<float,R,WS> *g_pybar,
